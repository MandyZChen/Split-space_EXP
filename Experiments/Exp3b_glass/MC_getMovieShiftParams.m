function params = MC_getMovieShiftParams(display,params)
%get parameters
...
params.randLabels = {'circle' 'random'};
params.symmetricLabels = {'asym' 'sym'};
...
params.filename = [params.subjID '_config' num2str(params.adaptConfig) '_r'  num2str(params.runNumber) '_' params.randLabels{params.randomRot+1} '_' params.symmetricLabels{params.symmetric+1} '_' folder '_' datestr(now,'mmddyyyy') '_' datestr(now,'HHMM')];
